		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comzeffortcalculatorhcl-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comzeffortcalculatorhcl-display": {
								"semanticObject": "comzeffortcalculatorhcl",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.zeffortcalculatorhcl",
									"url": sap.ui.require.toUrl("com/zeffortcalculatorhcl")
								}
							}
						}
					}
